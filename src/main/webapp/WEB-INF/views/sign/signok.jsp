...
<!--                     </tr> -->
            ...
            <form method="POST" action="/pms/sign/signok.do">
            <div class="centered-table">
            <table class="listtbl" style="text-align: center; width: 400px;">
            	<tr>
            		<th colspan="2" style="text-align: center;">결재 승인</th>
            	</tr>
            	<tr>
            		<td>승인하시겠습니까?</td>
            	</tr>
            	<tr>
            		<td>
            			<button type="submit" class="btn" value="승인">승인하기</button>	
...
<!--                 <input name="btn2" id="btn" class="btnred" value="취소" style="width: 25px;" onclick="history.back();"> -->
          ...
          <input type="hidden" name="action" value="${action}">
            ...
            <table class="listtbl" style="text-align: center; width: 400px;">
            	...
            	<tr>
            		<td>
            			<button type="submit" class="btn" value="거절">거절하기</button>	
            			<button type="button" class="btnred"
				onclick="history.back();">취소하기</button>
            		</td>
            	</tr>
